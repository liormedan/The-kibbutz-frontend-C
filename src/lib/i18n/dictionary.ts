...
const core = {
  he: {
    ...
    // Mobile bottom bar — one short word each so five slots fit at 360px.
    navShortExplore: "גילוי",
    navShortFeed: "פיד",
    navShortMessages: "הודעות",
    navShortProjects: "הפרויקטים",
    navMore: "עוד",
    close: "סגירה",
  ...
  en: {
    ...
    navShortExplore: "Explore",
    navShortFeed: "Feed",
    navShortMessages: "Messages",
    navShortProjects: "Projects",
    navMore: "More",
    close: "Close",
