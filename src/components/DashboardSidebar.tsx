...
export default function DashboardSidebar({
  ...
  const tabs: { id: DashboardTab; label: string; icon: ReactNode; route?: string }[] = [
    ...
    { id: "feed", label: "פיד", icon: <Newspaper className={sidebarCollapsed ? "w-7 h-7" : "w-5 h-5"} /> },
    { id: "portfolios", label: "תיקי עבודות", icon: <LayoutGrid className={sidebarCollapsed ? "w-7 h-7" : "w-5 h-5"} /> },
    ...
    { id: "messages", label: t.messages, icon: <MessageSquare className={sidebarCollapsed ? "w-7 h-7" : "w-5 h-5"} />, route: "/messages" },
    { id: "friends", label: t.friends, icon: <Users className={sidebarCollapsed ? "w-7 h-7" : "w-5 h-5"} /> },
    { id: "profile", label: t.profile, icon: <User className={sidebarCollapsed ? "w-7 h-7" : "w-5 h-5"} /> },
    { id: "settings", label: t.settings, icon: <SlidersHorizontal className={sidebarCollapsed ? "w-7 h-7" : "w-5 h-5"} /> },
  ];
